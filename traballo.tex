...
\input{options.tex}
\includeonly{capitulos/xestiondoproxecto}
\begin{document}
...
\include{capitulos/iteracions}\cleardoublepage
...
\include{capitulos/apendicec}\cleardoublepage
%\include{capitulos/licenza}\cleardoublepage
